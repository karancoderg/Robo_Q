...
interface GoogleOAuthButtonAltProps {
  text?: string;
  onSuccess?: (result: { success: boolean; needsSetup?: boolean; user?: any }) => void;
  onError?: () => void;
}

const GoogleOAuthButtonAlt: React.FC<GoogleOAuthButtonAltProps> = ({ 
    ...
    <div className="w-full">
      ...
      >
        {isLoading ? (
          ...
          <>
            <div className="animate-pulse rounded-full h-4 w-4 bg-gray-300 mr-2"></div>
            Loading...
          </>
        ) : (
          <>
...
export default GoogleOAuthButtonAlt;
